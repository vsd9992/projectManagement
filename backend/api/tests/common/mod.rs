...
/// project_id) — the teammate has all three roles so tests using this can
/// focus on business-logic correctness, not RBAC (already covered by
/// authz.rs).
pub async fn setup_project(prefix: &str) -> (TestApp, String, String, String) {
